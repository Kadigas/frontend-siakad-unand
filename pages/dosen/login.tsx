        ...
        <div className={styles.container}>
            ...
            <div>
                <div className={styles.card}>
                    ...
                    <form action="/dosen" method='post' className='mx-8'>
                        <label htmlFor="lid" className={styles.placeholder}>Lecturer ID: </label>
                        <input type="text" name="lid" placeholder="Enter your Lecturer ID..." size={54} className='mb-5 p-1'/>
