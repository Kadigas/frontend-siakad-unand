...
export default function Nav(){
    return (
        <header className='bg-white mt-0 fixed w-full z-10 top-0 flex flex-row text-lg'>
          ...
          <div className='basis-5/6 flex flex-row justify-between items-center'>
            <div className='basis-1/6 mx-5'>
              <a href='#' className='font-semibold'>Panduan Dosen</a>
            </div>
            <div className='basis-5/6 mx-5 flex flex-row justify-end'>
              <span className='font-semibold'>Agus Budi Pardede</span>
